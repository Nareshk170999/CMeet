...
const ConferenceScreen: React.FC<ConferenceScreenProps> = ({
  ...
  useEffect(() => {
    ...
    try {
      ...
      activateDemoMode("WebSocket unsupported");
      return;
    }
    ...
    ws.onclose = () => {
      ...
      if (!settled && !demoModeRef.current) {
        activateDemoMode("Connection closed");
      } else {
      ...
      <div className="relative z-10 h-full flex flex-col">
        <header className="flex items-center justify-between px-4 sm:px-6 pt-4 pb-2">
          <div className="flex items-center gap-3">
            <img src={logo} alt="Cognicx Meet" className="h-10 w-auto" />
            <div>
